...
const Login = () => {
	...
	return (
		<CSSTransition
			...
			classNames="page" // CSS class prefix for the transition
			unmountOnExit
		>
			<div className="flex page bg-slate-200">
				...
				<div className="flex justify-center items-start flex-col m-auto">
					...
					<form action="" className="flex justify-center items-start flex-col gap-10 drop-shadow-lg rounded-lg w-96 mb-4" onSubmit={handleSubmit}>
						<div className="relative w-full">
							<input id="username" type="text" value={username} onChange={handleUsernameChange} className="border border-gray-300 w-full py-2 px-3 rounded-md focus:border-black focus:outline-none" required />
							<label
								htmlFor=""
						...
						<input type="submit" value="Sign In" className="rounded w-full px-3 py-2 transition ease-in-out delay-60 bg-yellow-400 hover:-translate-y-1 hover:scale-110 hover:bg-yellow-500 duration-300 font-medium" />
					</form>
